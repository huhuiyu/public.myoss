(function() {
  ...
  ctrls.controller('ChangePwdCtrl', ['$scope', '$log', 'MyDataService', 'DialogService', 'MyUtilService', ChangePwdCtrl]);

  function ChangePwdCtrl($scope, $log, MyDataService, DialogService, MyUtilService) {
    $log.debug('ChangePwdCtrl init...');

    // 处理scope销毁
    $scope.$on('$destroy', function() {
      $log.debug('ChangePwdCtrl destroy...');
    });
